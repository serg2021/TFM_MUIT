...
if __name__ == "__main__":
    ...
    ### A CONTINUACIÓN, APLICAMOS EVOLUTIVO PARA ESCENARIOS. POR CADA ESCENARIO APLICAMOS EVOLUTIVO DEL PROBLEMA QUE SEA
    ...
    for i in range(Num_Generaciones):
        ...
        for k in range(Num_Generaciones):   #Bucle para sacar el Fitness de cada escenario
            ...
            Pob_Inicial = Ev1.PoblacionInicial(capacidad_bases, 100, numero_bases,numero_supply_depots,)  #POSIBLES SOLUCIONES PARA UNO DE LOS ESCENARIOS
