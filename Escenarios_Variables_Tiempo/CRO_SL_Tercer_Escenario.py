...
if __name__ == "__main__":
    ...
    for i in range(puntos_rio.shape[
                       0]):  # Los pasamos a UTM para hacer luego las intersecciones de cada tramo del río con las de bases y SD
    ...
    if not os.path.exists(punto_Rio):
        with rasterio.open(mapa_dem) as dem:
            ...
            indice_tramo = np.searchsorted(rio_acum,
                                           rand_distancia)  # Determinamos en qué tramo del río está el punto generado
